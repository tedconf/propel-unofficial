...
class JoinTest extends BaseTestCase 
{
  ...
  public function testGetConditions()
  {
    $j = new Join();
    $j->addCondition('foo', 'bar');
    $expect = array(array('left' => 'foo', 'operator' => '=', 'right' => 'bar', 'rightIsValue' => null));
  ...
  public function testAddConditions()
  {
    ...
    $expect = array(
      array('left' => 'foo', 'operator' => '=', 'right' => 'bar', 'rightIsValue' => null),
      array('left' => 'baz', 'operator' => '=', 'right' => 'bal', 'rightIsValue' => null)
    );
  ...
  public function testCompositeeConstructor()
  {
    ...
    $expect = array(
      array('left' => 'foo1', 'operator' => '=', 'right' => 'bar1', 'rightIsValue' => null),
      array('left' => 'foo2', 'operator' => '=', 'right' => 'bar2', 'rightIsValue' => null)
    );
    $this->assertEquals($expect, $j->getConditions());
    $this->assertEquals('LEFT JOIN', $j->getJoinType());
  }
