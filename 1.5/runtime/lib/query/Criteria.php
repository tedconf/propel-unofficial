...
class Criteria implements IteratorAggregate
{
	...
	/**
	* Returns a Criterion from a named condition
	*
	* @param      string $name Criterion name
	*
	* @return     Criterion
	*/
	public function getCond($name)
	{
	 ...
	 * @param      mixed $rightIsValue A Boolean indication the right side contains a value that needs to be escaped
	 *
	 * @return     Criteria A modified Criteria object.
	 */
	public function addJoin($left, $right, $operator = null, $rightIsValue = false)
	{
		$join = new Join(); // TODO: do we want to use CriterionJoin here? it is possible, but not very backwards compatible I guess...
		if (!is_array($left)) {
			// simple join
